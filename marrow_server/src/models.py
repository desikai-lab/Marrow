...
class TaskInput(BaseModel):
    ...
    priority: Annotated[str, Field(default="medium", description="Priority: critical, high, medium, low")] = "medium"
    blocked_by: Annotated[Any, Field(default=[], description="List of task IDs this task depends on")] = []
    status: Annotated[str, Field(default="open", description="Current status (e.g. open, in_progress, paused, closed)")] = "open"
...
class WriteRequest(BaseModel):
    ...
    content: Annotated[str, Field(description="Content to write or replace. In 'patch' mode, this is the replacement string.")]
