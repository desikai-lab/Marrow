...
class MaintenanceCommand(BaseCommand):
    ...
    def register_args(self, parser: argparse.ArgumentParser) -> None:
        ...
        group.add_argument("--all-projects", action="store_true", help="Discover and run for all projects")
        parser.add_argument("--older-than-hours", type=int, default=2, help="Version cleanup window (default: 2)")
        ...
        async def run_for_project(project_name: str):
            ...
            try:
                ...
                if report.errors:
                    ...
                    print(f"Maintenance finished successfully for {project_name}. "
