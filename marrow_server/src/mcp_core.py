...
async def search_code_skeletons(
    ...
    chunk_type: Annotated[str | None, Field(description="Optional filter by code unit type: 'namespace', 'class', 'method', 'constructor', 'property', 'file', etc.")] = None,
    ...
    root_path: Annotated[str | None, Field(description="Restrict search to files under this path prefix, e.g. 'src/worker'")] = None,
) -> list[dict[str, Any]]:
    """
