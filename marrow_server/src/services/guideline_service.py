...
def load(project: str, agent_role: str) -> GuidelineBundle | str:
    ...
    """
    core_text = tools.artifacts.read_artifact_logic(project, "docs/manuals/guidelines/core.md", 'full')

    try:
        yaml_text = tools.artifacts.read_artifact_logic(project, "docs/manuals/role_profiles.yaml", 'full')
