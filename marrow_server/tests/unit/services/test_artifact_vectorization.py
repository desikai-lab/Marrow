...
from tools.artifact_pipeline import (
    PipelineContext, ValidationHandler, GroupingHandler, PersistHandler
)
...
"""
    ...
    def test_grouping_handler_mixed_modes_sorts_chunks_before_sections(self):
        ...
        updates = [
            ...
            {"path": "file.md", "mode": "replace_chunk", "start_line": 10, "end_line": 12, "content": "CH1"},
            {"path": "file.md", "mode": "replace_chunk", "start_line": 5, "end_line": 6, "content": "CH2"},
        ]
    ...
    def test_save_project_artifacts_logic_chunk_updates_persists_correctly(self):
        ...
        updates = [
            {"path": path, "mode": "replace_chunk", "start_line": 2, "end_line": 2, "content": "New Line 2"},
            {"path": path, "mode": "replace_chunk", "start_line": 4, "end_line": 4, "content": "New Line 4"},
        ]
    ...
    def test_semantic_search_indexed_artifact_returns_relevant_result(self):
        ...
        cascade_results = asyncio.run(search_project_artifacts_logic(self.project, "specific artifact"))
        self.assertTrue(any(r["path"] == path for r in cascade_results), "Path not found in cascade search")
