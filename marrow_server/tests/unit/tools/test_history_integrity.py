...
class TestHistoryMdIntegrityHook(unittest.TestCase):
    def setUp(self):
    ...
    def test_validateAndRepair_replaceFile_alwaysRaisesEvenOnMissingFile(self):
        with self.assertRaises(ValidationError):
            self.hook.validate_and_repair(
                PROJECT, "docs/sessions/history.md", "## new -- content\n", "replace_file"
            )

    def test_validateAndRepair_replaceFile_alwaysRaisesOnExistingFile(self):
    ...
    def test_validateAndRepair_patchOnMissingFileWithEmptyOldStr_createsFileAndWritesContent(self):
    ...
    def test_validateAndRepair_patchOnMissingFileWithNonEmptyOldStr_raisesValidationError(self):
        with self.assertRaises(ValidationError):
            self.hook.validate_and_repair(
                PROJECT, "docs/sessions/history.md", "content\n", "patch", old_str="some old line\n"
            )

    def test_validateAndRepair_patchAnchoredAtFirstLine_allowsPrepend(self):
    ...
    def test_validateAndRepair_patchOldStrNotAtStart_raisesValidationError(self):
