...
from utils.exceptions import ValidationError, BaseBacklogError
...
def test_happy_path(tmp_path):
    ...
    with patch("tools.projects.PROJECTS_ROOT", str(tmp_path / "projects")), \
...
def test_project_already_exists(tmp_path):
    ...
    with patch("tools.projects.PROJECTS_ROOT", str(projects)), \
