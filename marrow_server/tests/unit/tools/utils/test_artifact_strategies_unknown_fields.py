...
def test_findUnknownFields_replaceFileWithOldStr_returnsWarning():
    ...
    assert (
        warning == "Field(s) 'old_str' are not used by write mode 'replace_file' and were ignored."
    )
...
def test_findUnknownFields_appendSectionWithStartLine_returnsWarning():
    ...
    warning = find_unknown_fields(
        strategy, {"path", "content", "mode", "section_name", "start_line"}
    )
    assert (
        warning
        == "Field(s) 'start_line' are not used by write mode 'append_section' and were ignored."
    )
...
def test_findUnknownFields_replaceSectionWithOldStr_returnsWarning():
    ...
    assert (
        warning
        == "Field(s) 'old_str' are not used by write mode 'replace_section' and were ignored."
    )
...
def test_findUnknownFields_replaceChunkWithSectionName_returnsWarning():
    ...
    assert (
        warning
        == "Field(s) 'section_name' are not used by write mode 'replace_chunk' and were ignored."
    )
...
def test_findUnknownFields_deleteSectionWithContent_returnsWarning():
    ...
    assert (
        warning
        == "Field(s) 'content' are not used by write mode 'delete_section' and were ignored."
    )
