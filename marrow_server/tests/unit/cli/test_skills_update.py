...
@patch("cli.commands.skills_update.SkillsRegistry")
def test_execute_deletes_existing_dir_before_fetch(mock_registry_class, mock_fetcher_class, tmp_path):
    with patch("cli.commands.skills_update.PROJECTS_ROOT", str(tmp_path)):
        mock_registry = mock_registry_class.return_value
...
@patch("cli.commands.skills_update.GitHubFetcher")
@patch("cli.commands.skills_update.SkillsRegistry")
def test_execute_skill_not_found_in_remote_exits_with_error(mock_registry_class, mock_fetcher_class, tmp_path):
    with patch("cli.commands.skills_update.PROJECTS_ROOT", str(tmp_path)):
        mock_registry = mock_registry_class.return_value
        mock_registry.get.return_value = {
            "name": "my-skill",
...
@patch("cli.commands.skills_update.GitHubFetcher")
@patch("cli.commands.skills_update.SkillsRegistry")
def test_execute_github_fetch_error_exits_with_error(mock_registry_class, mock_fetcher_class, tmp_path):
    with patch("cli.commands.skills_update.PROJECTS_ROOT", str(tmp_path)):
        mock_registry = mock_registry_class.return_value
        mock_registry.get.return_value = {
            "name": "my-skill",
...
@patch("cli.commands.skills_update.GitHubFetcher")
@patch("cli.commands.skills_update.SkillsRegistry")
def test_execute_success_updates_timestamp_and_prints(mock_registry_class, mock_fetcher_class, tmp_path, capsys):
    with patch("cli.commands.skills_update.PROJECTS_ROOT", str(tmp_path)):
        mock_registry = mock_registry_class.return_value
        mock_registry.get.return_value = {
            "name": "my-skill",
